...
/// @notice Provides validation for callbacks from Pegasys V3 Pools
library CallbackValidation {
    /// @notice Returns the address of a valid Pegasys V3 Pool
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (IPegasysV3Pool pool) {
